...
<template>
  <div class="flex items-center w-[40%] px-4 py-5 border-b border-gray-200">
    <!-- 프로필 이미지 -->
    <img
        :src="coffeechat.profileImageUrl"
    ...
    <div class="flex-1 overflow-hidden">
      <div
          class="text-sm truncate whitespace-nowrap overflow-hidden text-ellipsis"
