  ...
  <div class="space-y-8">
    <div class="flex gap-6">
      ...
      <div class="w-1/3 border rounded-lg p-6 flex flex-col items-center">
        ...
        <h2 class="text-xl font-bold mt-4">sezeme <span>🌚</span></h2>
        <p class="text-sm text-gray-500">백엔드 개발자</p>
        <p class="text-sm mt-2">온도 100번</p>
        <button class="mt-4 bg-blue-500 text-white px-4 py-2 rounded">프로필 수정</button>
      </div>

      <!-- 오른쪽: 커피챗 관리 -->
      <div class="w-2/3 border rounded-lg p-6">
